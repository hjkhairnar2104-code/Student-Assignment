...
const Footer = () => {
    ...
    return (
        <footer className="bg-slate-900 text-slate-300 min-h-10 mt-auto overflow-hidden relative">
            {/* Decorative animated blobs */}
            <div className="absolute -top-20 -left-20 w-64 h-64 rounded-full bg-indigo-900/40 blur-[80px] animate-[blob_12s_infinite] pointer-events-none" />
            <div className="absolute -bottom-20 right-10 w-72 h-72 rounded-full bg-sky-900/40 blur-[80px] animate-[blob_14s_infinite_2s] pointer-events-none" />
            <div className="absolute top-10 right-1/3 w-48 h-48 rounded-full bg-purple-900/30 blur-[60px] animate-[blob_10s_infinite_4s] pointer-events-none" />
            ...
            >
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 text-center sm:text-left">
                    ...
                    {/* Brand */}
                    <motion.div variants={itemVariants} className="flex flex-col space-y-4 items-center sm:items-start">
                        <Link to="/" className="flex items-center gap-2.5 group w-fit">
                            <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-gradient-to-br from-amber-400 via-indigo-600 to-violet-700 text-white shadow-lg transition-transform duration-300 group-hover:scale-105 border border-white/10">
                    ...
                    {/* Course Year */}
                    <motion.div variants={itemVariants} className="space-y-4 text-sm font-sans">
                    ...
                    <motion.div variants={itemVariants} className="space-y-6 text-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 justify-center sm:justify-start">
                                <MagneticElement>
                                    <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="http://x.com/pccoe_pune" className="block text-slate-400 hover:text-white transition-colors duration-200" aria-label="Twitter">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"></path></svg>
                                    </motion.a>
                                </MagneticElement>
                                <MagneticElement>
                                    <motion.a whileHover={{ scale: 1.2, rotate: -5 }} href="#" className="block text-slate-400 hover:text-white transition-colors duration-200" aria-label="GitHub">
                                ...
                                <MagneticElement>
                                    <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="https://www.linkedin.com/company/pccoe-pune/" className="block text-slate-400 hover:text-white transition-colors duration-200" aria-label="LinkedIn">
            ...
            <div className="border-t border-slate-800 bg-slate-950 px-4 py-6 sm:flex sm:items-center sm:justify-between">
                <div className="text-sm text-slate-500 mx-auto max-w-7xl w-full flex flex-col sm:flex-row justify-between items-center text-center">
                    <p className="mb-4 sm:mb-0">© {new Date().getFullYear()} StudyStash Inc. All rights reserved.</p>
