...
const Footer = () => {
    return (
        <footer className="bg-slate-900 text-slate-300 min-h-10 mt-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                    ...
                    <div className="space-y-6 text-sm">
                        <div className="space-y-4">
                            ...
                            <Link
                                to="/newsletter"
                                className="inline-flex items-center gap-1 group text-slate-300 hover:text-white transition-colors duration-200"
                            >
                                Newsletter
            ...
            {/* Bottom Bar */}
            <div className="border-t border-slate-800 bg-slate-950 px-4 py-6 md:flex md:items-center md:justify-between">
                <div className="text-sm text-slate-500 mx-auto max-w-7xl w-full flex flex-col md:flex-row justify-between items-center text-center">
